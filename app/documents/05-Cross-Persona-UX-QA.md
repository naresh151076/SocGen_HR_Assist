...
- New chat opens as a conversation-shaped first state: compact header, assistant opening with the persona ask, inline composer, governance boundary, then suggested starts. It must not use a centred empty-state hero.
