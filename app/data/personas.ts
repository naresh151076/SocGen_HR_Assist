...
export const personas: Persona[] = [
  ...
  { id:"amelie", name:"Amélie Martin", initials:"AM", role:"Training Coordinator, ACO/GES", location:"Paris", greeting:"What programme do you need to plan?", prompt:"Describe the programme, cohort and deadline you are planning for.", flowTitle:"Plan a viable session before publication", primaryAction:"Review the plan", starters:["Validate a programme plan","Find capacity for a cohort","Resolve a trainer or room conflict"], stats:[{value:"16",label:"seats proposed"},{value:"12",label:"people requested"},{value:"1",label:"plan to approve"}] },
  { id:"claire", name:"Claire Martin", initials:"C", role:"Business Manager", location:"Paris", greeting:"What does your team need to learn?", prompt:"Describe the learning need for your team.", flowTitle:"Secure mandatory training for your team", primaryAction:"Review 12 people", starters:["Plan mandatory training for my team","Show who on my team still needs learning","Resolve an attendee exception"], stats:[{value:"24",label:"people in unit"},{value:"18",label:"need action"},{value:"1",label:"open follow-up"}] },
