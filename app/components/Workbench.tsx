...
const guidedTurns:GuidedTurn[]=[
  ...
  {persona:"Elena",initials:"E",user:"Review the invitation control for this cohort.",assistant:"INV-04 found one confirmed registration without a current invitation after a session change: François Laurent. The registration is correct; one contained invitation remediation is ready.",question:"Do you approve sending the replacement invitation and re-checking the control?",action:"Approve remediation",nextPersona:"elena"},
